...
@Component({
    selector   : 'as-mail-main-sidenav',
    templateUrl: './main-sidenav.component.html',
    styleUrls  : ['./main-sidenav.component.scss'],
    animations : asAnimations
})
export class AsMailMainSidenavComponent implements OnInit, OnDestroy
{
    folders: any[];
    filters: any[];
    labels: any[];
    ...
    composeDialog()
    {
        this.dialogRef = this.dialog.open(AsMailComposeDialogComponent, {
